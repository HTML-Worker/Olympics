(function () {
    ...
    function managementAdmCtrl($scope, $location, $http) {
        ...
        $scope.gradeName = selectData.grade;
        ...
        $http({
            ...
            $scope.countTeacher = data.length;
        ...
        $scope.checkbox = function (btn) {
            if ($scope.identity === "教师") {
                ...
                if ($("#student" + btn)[0].checked) {
                    $("#student" + btn).parent().prevAll().andSelf().css("background-color", "#dff0d8");
                }else {
                    $("#student" + btn).parent().prevAll().andSelf().css("background-color", "#f9f9f9");
                }
            }
        ...
        $scope.deleteButton = function () {
            if ($scope.identity === "教师") {
                if (0 === $scope.checkboxs.length) {
                    ...
                    $http({
                        method: "post",
                        url: "http://localhost:8080/OlympicsAPI/rest/TeacherMessage/deleteTeacherMessage",
                        data: {
                            studentNum: $scope.checkboxs
                        },
                        headers: {
